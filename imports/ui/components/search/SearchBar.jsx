...
export default SearchBar = props => {
  return(
    <div id="searchBar" className="col s12">
      <div className="col s12 l10 searchBar_fields-wrapper" style={{padding: "0px 15px", borderRight: "1px solid rgba(0,0,0,0.1)"}}>
        ...
        <div className="col s6 l3" style={{padding: "0"}}><HomeCategorySearch /></div>
      </div>

      <div className="col s12 searchBar_fields-wrapper" style={{padding: "0px", borderRadius: "4px", overflow: "hidden"}}>
        <div className="col s6 l2 center valign-wrapper clickable" style={{background: "transparent", padding: "0", height: "100%"}}>
          <h5 className="valign centerByMargin white-text"><i className="fa fa-location-arrow" aria-hidden="true"></i></h5>
        </div>
        
        <div className="col s6 l2 center valign-wrapper clickable" onClick={() => search()} style={{background: "transparent", padding: "0", height: "100%", borderRight: "1px solid rgba(0,0,0,0.1)"}}>
