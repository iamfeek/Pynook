...
export default PynActions = props => {
  return(
    <div className="pyn_actions">
      <a href="#respond" className="action">
        <span className="pyn_action_icon action_icon">
          <svg width="15px" height="15px" viewBox="0 0 15 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Page---Listing" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Icon-Slicing" transform="translate(0.000000, -1.000000)">
                <g id="Imported-Layers-Copy">
                  <use fill="currentColor" fillRule="evenodd" xlinkHref="#path-1"></use>
                  <use fill="none" xlinkHref="#path-1"></use>
                </g>
              </g>
            </g>
          </svg>
        ...
        <span className="pyn_action_text action_text">
          Write A Review
        </span>
      </a>
